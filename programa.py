...
if __name__ == "__main__":
    ...
    print("El área del circulo es: "+ area_circulo(radio))# Se imprime el área calculada del círculo

#6 Define una función que reciba dos números como argumentos y devuelva su suma.
def suma(a, b):
   x=a+b 
   return x# Se devuelve la suma de los dos números recibidos como argumentos
...
def area_circulo(radio):
    pim=math.pi
    area = pim* radio**2 # Se calcula el área del círculo utilizando la fórmula matemática
    return area# Se devuelve el área calculada
